# Lab 49: LLM Red Teaming - Attacking AI Systems
...
| Training Poisoning | LLM03 | Lab 39 |
...
> **Stuck?** See the [Lab 49 Walkthrough](../../docs/walkthroughs/lab49-llm-red-teaming-walkthrough.md) for step-by-step guidance.

## 🎯 Next Steps

Congratulations on completing Lab 49! You've finished the core lab series.

- **Capstone Projects**: Apply your skills to build production systems
- **Lab 39**: Adversarial ML attacks on security models (if not completed)
