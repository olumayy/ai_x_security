...
- Completed Lab 00a (Python basics) OR comfortable with Python
- Completed Lab 00b (ML concepts) OR understand supervised learning basics
...
python labs/lab00f-hello-world-ml/starter/main.py
```
