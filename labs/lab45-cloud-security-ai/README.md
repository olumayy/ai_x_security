...
If you're not familiar with AWS/Azure/GCP, IAM, or CloudTrail, complete [Lab 44: Cloud Security Fundamentals](../lab44-cloud-security-fundamentals/) first. It covers:
...
> **Stuck?** See the [Lab 45 Walkthrough](../../docs/walkthroughs/lab45-cloud-security-ai-walkthrough.md) for step-by-step guidance.
